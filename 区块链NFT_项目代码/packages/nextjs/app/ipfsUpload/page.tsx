            ...
            {imageData.map((row) => (
              <tr key={row.id}>
                ...
                <td className="border border-gray-400 p-2">
                  <a href={`https://silver-selective-elephant-108.mypinata.cloud/ipfs/${row.onChainAddress}`} target="_blank" rel="noreferrer">
                    {`https://silver-selective-elephant-108.mypinata.cloud/ipfs/${row.onChainAddress}`}
                  </a>
                </td>
              </tr>
            ))}
